...
#Create User
10.times do
  user = User.create!(first_name: Faker::DragonBall.character, last_name: Faker::Name.last_name , description: Faker::HowIMetYourMother.quote, email: Faker::Internet.email, age: Faker::Number.between(18, 75), city_id: City.all.ids.sample, password: Faker::Internet.password(8))
end
